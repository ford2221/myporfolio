...
export const experiences = [
    {
        ...
        tags: [
            "• Developed mobile and desktop applications using Flutter.",
            "• Built a POS sales system for managing sales and products in retail environments.",
            "• Created a network components tracking app integrating Google Maps for fiber optic management.",
            "• Designed for internal use only, without client registration features.",
            "• Collaborated with team members to optimize app performance."
        ]
    },
    {
        company: "CorpoEureka", 

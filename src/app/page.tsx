    ...
    <>
      ...
      <main className="min-h-screen bg-black text-slate-200 font-sans px-1">
        <div className="max-w-5xl mx-auto p-4 sm:p-6">
          <header>
            <div className="flex md:items-center justify-center  gap-4 flex-wrap mb-4">
              ...
              <div className='w-64 md:w-2/3'>
                ...
                <p className="text-xs opacity-80 text-center md:text-left mt-1 tracking-widest leading-none">Web & Móvil Developer • Portafolio retro</p>
          ...
          <section className="mb-8">
            <h3 className="text-lg sm:text-xl font-bold mb-4">☕ Hobbies</h3>
          ...
          <section id="projects" className="mb-12">
            <h3 className="text-lg sm:text-xl font-bold mb-4">🖥️ Projects</h3>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
              ...
              {loading && (
                <div className="flex justify-center items-center mt-4">
                    ...
                    <p className='ml-4 text-white'>Wait...</p>
                </div>
              )}
            </form>
            <div></div>
